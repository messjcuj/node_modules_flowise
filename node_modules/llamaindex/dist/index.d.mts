...
declare class OpenAIEmbedding extends BaseEmbedding {
    ...
    maxRetries: number;
    timeout?: number;
    additionalSessionOptions?: Omit<Partial<ClientOptions>, "apiKey" | "maxRetries" | "timeout">;
 ...
 */
interface QueryEngineParamsBase {
    query: string;
    parentEvent?: Event;
}
interface QueryEngineParamsStreaming extends QueryEngineParamsBase {
    stream: true;
}
interface QueryEngineParamsNonStreaming extends QueryEngineParamsBase {
    stream?: false | null;
}
/**
 ...
 */
declare abstract class ChatHistory {
...
declare class SimpleChatHistory extends ChatHistory {
    messages: ChatMessage[];
...
declare class SummaryChatHistory extends ChatHistory {
...
declare function getHistory(chatHistory?: ChatMessage[] | ChatHistory): ChatHistory;
...
interface ChatEngineParamsStreaming extends ChatEngineParamsBase {
    stream: true;
}
interface ChatEngineParamsNonStreaming extends ChatEngineParamsBase {
    stream?: false | null;
}
/**
