...
export declare class ChatCohere<CallOptions extends CohereChatCallOptions = CohereChatCallOptions> extends BaseChatModel<CallOptions> implements ChatCohereInput {
    ...
    invocationParams(options: this["ParsedCallOptions"]): {
        [k: string]: string | number | CallOptions["preambleOverride"] | CallOptions["conversationId"] | CallOptions["promptTruncation"] | CallOptions["connectors"] | CallOptions["searchQueriesOnly"] | CallOptions["documents"] | CallOptions["citationQuality"] | undefined;
    };
    /** @ignore */
